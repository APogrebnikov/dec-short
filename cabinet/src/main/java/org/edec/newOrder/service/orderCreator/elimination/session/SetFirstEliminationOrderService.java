...
public class SetFirstEliminationOrderService extends OrderService {
    private final String attr1 = "первой";
    ...
    public Long createOrderInDatabase(List<Object> orderParams, List<OrderCreateStudentModel> students) {
        ...
        List<OrderCreateStudentModel> listStudents = studentsOrderManager
                .getStudentForFirstEliminationAfterSession((Date) orderParams.get(0),
