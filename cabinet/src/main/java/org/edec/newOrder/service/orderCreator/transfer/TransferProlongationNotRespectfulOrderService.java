...
public class TransferProlongationNotRespectfulOrderService extends OrderService {
    @Override
    ...
    public Long createOrderInDatabase (List<Object> orderParams, List<OrderCreateStudentModel> students) {
        ...
        List<OrderCreateStudentModel> listStudents = studentsOrderManager
                .getStudentsForSetEliminationAfterTransferProlongation(getParamsGetter().getIdSemesterFromParams(orderParams), strGroups, false);
