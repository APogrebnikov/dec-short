...
public class CancelSocialIncreasedByPracticeOrderService extends OrderService {
    ...
    protected void generateParamModel() {
        ...
        orderSectionVisualParamsMap.put(118L, orderVisualGeneralParamsCancel);
        ...
        orderSectionVisualParamsMap.put(119L, orderVisualGeneralParamsAssign);
    }
    ...
    public Long createOrderInDatabase(List<Object> orderParams, List<OrderCreateStudentModel> students) {
        ...
        for (OrderCreateOrderSectionModel section : listSections) {
            ...
            List<OrderCreateStudentModel> listStudents = studentsOrderManager.getSocialIncreasedStudentsWithScholarshipChanging();

            // прекращение выплат
            if(section.getId().equals(118L)) {
                ...
                for (OrderCreateStudentModel student : listStudents) {
                    getOrderCreateService().createStudentInSection(idLOS, student.getId(), (Date) orderParams.get(0), student.getDateSocialScholarshipTo(), student.getGroupname(), "");
                }
            }
